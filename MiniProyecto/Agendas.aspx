<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Agendas.aspx.cs" Inherits="Agendas" %>
...
<body class="landing">
					...
					<section class="box special">
						<header class="major">
							...
							<form id="form1" runat="server">
                                ...
                                <div>
                                     <asp:Calendar ID="Calendar1" runat="server" OnDayRender="Calendar1_DayRender" OnSelectionChanged="Calendar1_SelectionChanged1" ></asp:Calendar>
                                </div>
                                 <div>
        
                                     &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; <asp:Label ID="Label1" runat="server" Text="Medicos"></asp:Label>  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;     
        
                                     <br />
        
                                     <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>  &nbsp;<asp:Label ID="Label2" runat="server" Text="Paciente"></asp:Label>
    ...
    <div>
        ...
        &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<br />
        Horario&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  <asp:DropDownList ID="DropDownList4" runat="server"></asp:DropDownList>
        <br />
   ...
   <div>
       ...
       <br />
       &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; <asp:Button ID="Button1" runat="server" Text="Agendar" OnClick="Button1_Click" />
