...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AltaDoc.aspx.cs" Inherits="index" %><!DOCTYPE html>
				...
				<section id="main" class="container">
					...
					<section class="box special">
						<header class="major">
                            ...
                            <asp:Label ID="Label4" runat="server" Text="Especialidad"></asp:Label> &nbsp; <asp:TextBox ID="TextBox4" runat="server" CausesValidation="True"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Escriba su especialidad" ControlToValidate="TextBox4" ForeColor="#990000"></asp:RequiredFieldValidator>
                            <br />
